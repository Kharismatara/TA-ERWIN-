          ...
          <Card.Body style={{ textAlign: "left" }}>
            ...
            <Form>
              ...
              <Form.Floating className="mb-3">
                <Form.Control id="floatingInputName" type="text" placeholder="Name..." value={newName} onChange={(event) => setNewName(event.target.value)} style={{ fontSize: "14px" }} />
              ...
              <Form.Floating className="mb-3">
                <Form.Control type="file" accept="image/*" onChange={handleImageChange} style={{ fontSize: "14px" }} />
            ...
            {selectedImage && (
              <div style={{ marginTop: "20px" }}>
                ...
                <img src={URL.createObjectURL(selectedImage)} alt="Bukti Pembayaran" style={{ maxWidth: "100%", maxHeight: "200px", marginTop: "10px" }} />
              </div>
            )}
          </Card.Body>
        </Card>
